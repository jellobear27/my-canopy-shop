  ...
  <div className="bg-black/30 backdrop-blur-sm overflow-hidden py-2 px-4">
    <div className="whitespace-nowrap animate-scrollText inline-block">
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 text-lg font-light tracking-wider">
        Now Serving Denver • Now Serving Denver • Now Serving Denver • Now Serving Denver •&nbsp;
      </span>
    </div>
  </div>
);
    ...
    {products.map(product => (
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="mt-6">
            <p className="font-bold text-purple-400 text-xl">${product.price}</p>
            <p className="text-sm mt-2 text-gray-400">Available sizes: {product.sizes.join(", ")}</p>
          </div>
          <button
...
export default function BedCanopyShop() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 1499.99,
      description: "A sanctuary inspired by cosmic energy and mountain serenity",
    ...
    },
    {
      ...
      name: "Urban Mystic",
      price: 1299.99,
      description: "Modern spirituality meets Denver's urban edge",
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex space-x-6">
              ...
              >
                ...
                <span className="font-light tracking-wider">Cart ({cart.length})</span>
              </button>
            </div>
          </div>
        </div>
      ...
      {/* Main Content */}
      {currentPage === 'gallery' && <Gallery products={products} addToCart={addToCart} />}
        ...
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="bg-black/40 backdrop-blur-md rounded-lg p-8 text-gray-300">
            <p className="mb-6 font-light tracking-wide">
              We craft ethereal bed canopies that transform your sleeping space into a sanctuary of 
              tranquility and style. Each piece is designed to blend contemporary aesthetics with 
              mystical elements, creating an atmosphere that elevates both your space and spirit.
            </p>
            <p className="mb-6 font-light tracking-wide">
              Our designs draw inspiration from Colorado's mystical landscapes - from the enigmatic 
              fog that embraces the Rockies to the celestial clarity of our starlit nights. Each 
              canopy is crafted to bring this magical essence into your personal space.
            </p>
            <div className="mt-6 bg-white/10 border border-purple-400 rounded-lg p-4">
              <h3 className="text-purple-400 font-semibold">Experience the Magic in Person</h3>
              <p className="text-gray-300 mt-2">
                Visit our Denver showroom to see how our canopies transform spaces in real-time.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Cart Sidebar */}
      <div className={`fixed inset-y-0 right-0 w-full md:w-96 bg-black/80 backdrop-blur-lg transform ${showCart ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out text-white`}>
        <div className="h-full flex flex-col p-6">
          ...
          <div className="flex-grow overflow-y-auto">
            {cart.map(item => (
              <div key={item.id} className="flex items-center justify-between mb-4 p-4 border border-white/20 rounded-lg backdrop-blur-md">
                <div>
          ...
          {cart.length > 0 ? (
            <div className="mt-4">
              ...
              <button 
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg hover:from-purple-500 hover:to-blue-500 transition-all duration-300 font-light tracking-wider flex items-center justify-center space-x-2"
              >
                <CreditCard size={20} />
